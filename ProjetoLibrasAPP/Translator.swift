...
//        return words
    ...
    func classify(var phrase:String) -> [Word]{
        ...
        do {
            ...
            let endpoint = NSURL(string: "http://172.16.1.22:3000/word/classify/true/" + phrase + "/")
    ...
    func get_verbs(motto:String, flexion:String) -> String{
        ...
        do {
            ...
            let endpoint = "http://172.16.1.22:3000/word/verbs/true/" + params + "/"
    ...
    func get_nouns(motto:String, flexion:String) -> String{
        ...
        do {
            ...
            let endpoint = NSURL(string: "http://172.16.1.22:3000/word/nouns/true/" + params + "/")
            let data:NSData = NSData(contentsOfURL: endpoint!)!
    ...
    func get_adjectives(motto:String, flexion:String) -> String{
        ...
        do {
            ...
            let endpoint = NSURL(string: "http://172.16.1.22:3000/word/adjectives/true/" + params + "/")
            let data:NSData = NSData(contentsOfURL: endpoint!)!
